...
-- 初始化全局统计数据
INSERT INTO sora2_analytics (id, total_submit_count, total_copy_clicks, total_worked_votes, total_didnt_work_votes, total_unique_users)
VALUES (1, 0, 0, 0, 0, 0)
...
- sora2_analytics: 全局统计表，存储整个系统的汇总数据
...
- game_analytics: 游戏全局统计表，存储游戏的汇总数据
